...
public class Parser {
    ...
    static int minLevel = 10, maxLevel = 10;
    ...
    public static void takeLevelTiles(int level) throws Exception {
        ...
        // устанавливаем экран отображения карты (курсор текущего фрейма) в верхний левый угол
        ...
        for (int x = 0; x <= halfSteps; x++){

            // костыль для перезапуска парсинга
            while (x < 800){
                moveRight();
                moveRight();
                x++;
