 ...
 * -- запущенный tile_renderer на localhost:8000 (приложен скрипт запуска - server.sh через питон)
...
public class ParserRussiaSeq {
    ...
    static int minLevel = 0, maxLevel = 5;
...
//            mkDirs(level);
            ...
            // пересчитаем maxCols так, чтобы не выходить за максимум тайлов: кэши и оперативка закончатся раньше 100 000 тайлов
